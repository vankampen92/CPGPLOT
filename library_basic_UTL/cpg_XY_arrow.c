...
void cpg_XY_arrow(int n, float *xs, float *ys, float *Range_x, float *Range_y, 
...
{  
  ...
  cpgsch(0.66); // cpgsch(0.83);
    
  cpg_XY_same_arrow( n, xs, ys, 
		     color_Index, type_of_Line, type_of_Width );
  return;
}
